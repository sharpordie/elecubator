...
xmlstarlet ed --inplace -u '//*[@id="audiooutput.audiodevice"]' -v 'ALSA:hdmi:CARD=AMLAUGESOUND,DEV=0' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="audiooutput.audiodevice"]/@default' -v 'false' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="audiooutput.channels"]' -v '10' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="audiooutput.channels"]/@default' -v 'false' "${gui_settings}"
...
xmlstarlet ed --inplace -u '//*[@id="audiooutput.passthroughdevice"]' -v 'ALSA:hdmi:CARD=AMLAUGESOUND,DEV=0' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="audiooutput.passthroughdevice"]/@default' -v 'false' "${gui_settings}"
...
xmlstarlet ed --inplace -u '//*[@id="locale.subtitlelanguage"]' -v 'default' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="locale.subtitlelanguage"]/@default' -v 'false' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="locale.timezone"]' -v 'Europe/Brussels' "${gui_settings}"
xmlstarlet ed --inplace -u '//*[@id="locale.timezone"]/@default' -v 'false' "${gui_settings}"
